...
export default class Stats {
    ...
    constructor({
        ...
        const config = DeepMerge<DefaultPanelsConfig>(structuredClone(Stats.defaultConfig), defaultPanels as DefaultPanelsConfig) satisfies DefaultPanelsConfig;
        ...
        for (const [name, panelConfig] of Object.entries(config)) {
            // @ts-expect-error It's just like this for now
            if (panelConfig === false) {//Fixme. It's a mess
                continue;
            }
